...
$(function ($) {
     ...
     var horizontalinner1_height = $('#parallax-video .horizontalinner1').height();
     var custom_padding = (vH - (horizontalinner1_height + 75))/2;

     $('#parallax-video .horizontalinner1').css("padding-top", custom_padding);
     $('#parallax-video .horizontalinner1').css("padding-bottom", custom_padding);
});